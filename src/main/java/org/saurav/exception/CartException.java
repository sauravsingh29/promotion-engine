...
public class CartException extends Exception {
    ...
    public CartException(String message, final @NonNull String source, final @NonNull HttpStatus statusCode) {
        super(message);
        if (isBlank(message)) {
    ...
    public CartException(final @NonNull String source, String message, final @NonNull Throwable cause,
    ...
    public CartException(final @NonNull String source, final @NonNull Throwable cause) {
