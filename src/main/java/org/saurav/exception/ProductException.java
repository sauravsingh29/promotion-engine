...
public class ProductException extends Exception {
    ...
    public ProductException(String message, final @NonNull String source, final @NonNull HttpStatus statusCode) {
        super(message);
        if (isBlank(message)) {
    ...
    public ProductException(final @NonNull String source, String message, final @NonNull Throwable cause,
    ...
    public ProductException(final @NonNull String source, final @NonNull Throwable cause) {
